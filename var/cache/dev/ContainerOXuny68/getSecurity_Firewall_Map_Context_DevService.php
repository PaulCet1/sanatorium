...
class getSecurity_Firewall_Map_Context_DevService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        }, 0), NULL, NULL, new \Symfony\Bundle\SecurityBundle\Security\FirewallConfig('dev', 'security.user_checker', '.security.request_matcher.F.8bu_W', false, false, NULL, NULL, NULL, NULL, NULL, [], NULL, NULL));
    }
}
