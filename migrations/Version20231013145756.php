 ...
 */
final class Version20231013145756 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C849555D0C1BBB FOREIGN KEY (rehabilitationstay) REFERENCES rehabilitation_stay (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
        $this->addSql('ALTER TABLE reservation ADD CONSTRAINT FK_42C84955C7440455 FOREIGN KEY (client) REFERENCES user (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
